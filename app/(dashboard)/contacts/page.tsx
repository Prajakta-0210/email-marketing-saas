...
import { Search, Upload, Pencil, Trash2, MoreHorizontal, Users } from "lucide-react";
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            {contacts.length.toLocaleString()} total contacts in your workspace
          </p>
        </div>
              ...
              <TableBody>
                {filtered.map((contact) => (
                  <TableRow key={contact.id}>
                    ...
                    <TableCell>
                      <Badge className={cn("border-transparent", statusStyles[contact.status])}>
                        {contact.status}
                      </Badge>
                    </TableCell>
                    <TableCell className="text-right">
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <button
                            className="rounded-md p-1.5 text-gray-400 hover:bg-gray-100 hover:text-gray-600 sm:hidden"
