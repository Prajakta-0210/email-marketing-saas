...
export const navItems = [
  ...
  { name: "Audiences", href: "/audiences", icon: UserRoundCheck },
    ...
    <div className="flex h-full flex-col justify-between">
      ...
      <div className="p-4 border-t">
        <Link
          href="/login"
          onClick={onNavigate}
          className="flex items-center gap-3 w-full px-4 py-3 rounded-xl text-gray-600 hover:bg-red-50 hover:text-red-500 transition"
        >
          <LogOut size={20} />
          Logout
        </Link>
